                                ...
                                <td>
                                  <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                    <li
                                      ...
                                      title="Lilian Fuller"
                                    >
                                      <img src="{{ asset('sneat-1.0.0/assets/img/avatars/5.png')}}" alt="Avatar" class="rounded-circle" />
                                    </li>
                                    <li
                                      data-bs-toggle="tooltip"
                                      data-popup="tooltip-custom"
                                    ...
                                    >
                                      <img src="{{ asset('sneat-1.0.0/assets/img/avatars/6.png')}}" alt="Avatar" class="rounded-circle" />
                                    </li>
                                    <li
                                      data-bs-toggle="tooltip"
                                      data-popup="tooltip-custom"
                                    ...
                                    >
                                      <img src="{{ asset('sneat-1.0.0/assets/img/avatars/7.png')}}" alt="Avatar" class="rounded-circle" />
                                    </li>
                                  </ul>
                                </td>
